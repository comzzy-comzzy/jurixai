...
values
  ...
  ('zera-04', 'Zera', 'ZR', 'Delivery Judge', 'Documentation, reproducibility, polish, and shipping quality.', 'idle', '#EF4444', 20, 'Check if the project is actually shipped: repo quality, README completeness, video clarity, and reproducibility.', 'Broken demos, dead links, and missing instructions should materially reduce the score.')
